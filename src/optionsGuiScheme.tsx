  ...
  render: [
    ...
    },
    {
      ...
      renderPixelRatio: {
        ...
        tooltip: 'Sets the WebGL pixel ratio. "Auto" uses your display\'s full resolution. Lower values (0.5x, 0.75x) render below native for big performance gains on low-end devices.',
      },
      potatoMode: {
        text: 'Potato Mode',
    ...
    },
    {
      ...
      showNametags: {
        text: 'Show Nametags',
        tooltip: 'Show player and entity name labels above them.',
      },
      keepChunksDistance: {
        max: 5,
        unit: '',
